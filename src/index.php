...
<main>
	...
	<section class="section-1 why-joomla">
		<div class="container">
			<div class="row"><?php include __DIR__ . '/data/why-joomla.php'; ?></div>
		</div>
	</section>
	<section class="section-2 features">
		<div class="container">
			<div class="row"><?php include __DIR__ . '/data/features.php'; ?></div>
		</div>
	</section>
	<section class="section-3 finder">
		<div class="container">
			<div class="row"><?php include __DIR__ . '/data/finder.php'; ?></div>
		</div>
	</section>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					...
					<p class="lead">Small trompet duis tincidunt nunc et odio bibendum tincidunt a non magna.
						Consectetur
						adipiscing elit.</p>
					<p>Augue vel diam lobortis efficitur. Quisque sollicitudin vulputate lorem, eget dignissim magna
						...
						lectus a varius vestibulum. Nullam facilisis ornare pretium. Ut gravida, ex ac volutpat
						ultrices,
						urna justo imperdiet sapien, ac rhoncus lorem odio in est.</p>
					<p class="lead-lg text-serif">Nunc varius suscipit mauris vel convallis. Curabitur mattis placerat
						mi
						eget vestibulum. Donec eros ligula, viverra a erat sit amet, facilisis lobortis lorem. Aliquam
						non
					...
					<p>Proin a mi lobortis, molestie arcu quis, scelerisque tellus. Vestibulum faucibus tristique
						ullamcorper. Sed molestie eget quam at finibus. Mauris et ante non nibh mollis dapibus ac in
						lacus.
						Nunc euismod auctor ex et mollis.</p>
					<h3>h3 Mauris gravida molestie commodo</h3>
					<p>Vivamus et elit blandit, tincidunt orci elementum, molestie justo. Morbi ornare lectus felis,
						vitae
						fermentum tellus finibus sit amet. Nulla facilisi. In suscipit magna quis arcu bibendum, sit
						amet
						egestas nunc laoreet. Vestibulum consectetur elementum tellus convallis tristique. Sed lacinia
						varius tincidunt. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur
						ridiculus
						mus.</p>
					...
					<p>Nunc varius suscipit mauris vel convallis. Curabitur mattis placerat mi eget vestibulum. Donec
						eros
						ligula, viverra a erat sit amet, facilisis lobortis lorem. Aliquam non dapibus sapien, id
						faucibus
						mauris.</p>
					<p>Proin a mi lobortis, molestie arcu quis, scelerisque tellus. Vestibulum faucibus tristique
						ullamcorper. Sed molestie eget quam at finibus. Mauris et ante non nibh mollis dapibus ac in
					...
					<p class="text-center">Small trompet duis tincidunt nunc et odio bibendum tincidunt a<br/> non
						magna.
